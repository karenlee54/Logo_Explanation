...
class Triangle_T(Triangle):
  def draw(self):
    ...
    p5.textFont(Font, 35)
    p5.text('Triangle means END like a period', 0, 515)
    p5.textFont('Helvetica', 40)
    p5.text('△', 525, 515)
    p5.textFont(Font, 25)
    p5.text('But we still can expand our ideas beyond the end!', 0, 565)
    p5.text('This is your place! Draw anything you want', 0, 600)
...
def draw():
  ...
  if (program_state == 'PLAY'):
    ...
    p5.text('their meaings in my branding...', 25, 205)
